...
public class HolderAdapter extends RecyclerView.Adapter<HolderAdapter.Myviewholder> {
    ...
    public HolderAdapter(Context context, ArrayList<Holderlistview> profiles) {
    ...
    public Myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Myviewholder(LayoutInflater.from(context).inflate(R.layout.holder_view,parent, false));
    }
